...
class TestDBOperations(unittest.TestCase):
    ...
    def testGetCandleInsertQuery(self):
        ...
        marketPair = 'ETHUSDT'
        candleSize = '15m'
        print('TS: ' + HelpfulOperators.convertNumericTimeToString(1583535600000))

        expected = "INSERT INTO ETHUSDT_OHLCV_15m(timestamp, open, high, low, close, volume) VALUES ('2020-03-06 23:00:00', '239.99', '240.59', '239.75', '240.59', '1768.84486');"
