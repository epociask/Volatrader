    ...
    def start(self):
        ...
        while datetime.datetime.now() < end_time:
            ...
            if (t % self.timeStep == 0 or t == 0):
                ...
                print("bought status ->", bought)
                if not bought:
                    time.sleep(60)


            if (t == 0) and datetime.datetime.now().second == 0:
            ...
            if bought:
                ...
                print(f"Checking for sell w/ {self.pair} @ {self.currentPrice}")
            ...
            if datetime.datetime.now().minute % 5 == 0 and self.currentPrice is not None:
                print("WRITING CURRENT PNL for session", self.sessionid)
